...
class ListStudentWidget extends StatelessWidget {
  ...
  Future<void> deleteDialog(int index, BuildContext ctx) async {
    return showDialog(
      context: ctx,
  ...
  editDialog(BuildContext context, StudentModel data,int index) async {
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              ...
              await updateStudent(index, updatedStudent);
              Navigator.pop(context);
            },
